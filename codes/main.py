...
#
# GFSL setting
# CUDA_VISIBLE_DEVICES=0 python3 -u main.py --dataset FLO --num_shots 1 --a 1e-2 --b 1e-3 --c 1e-3 --nz 400 --center_weight 0.001 --syn_num 800 --batch_size 2048 --i_c 0.1 --cls_weight 0.005 --n_clusters 1  --structure_weight 1e-1 --nepoch 250 > flo0.log 2>&1 &
# 1-shot GFSL: best_seen=0.964, best_unseen=0.740, best_h=0.837, run_time=2612.5557
# CUDA_VISIBLE_DEVICES=1 python3 -u main.py --dataset FLO --num_shots 3 --a 1e-2 --b 1e-3 --c 1e-3 --nz 400 --center_weight 0.001 --syn_num 800 --batch_size 2048 --i_c 0.1 --cls_weight 0.005 --n_clusters 3 --structure_weight 1e-1 --nepoch 250 > flo1.log 2>&1 &
# 3-shot GFSL: best_seen=0.943, best_unseen=0.832, best_h=0.884, run_time=1391.6268
# CUDA_VISIBLE_DEVICES=2 python3 -u main.py --dataset FLO --num_shots 5 --a 1e-2 --b 1e-3 --c 1e-3 --nz 400 --center_weight 0.001 --syn_num 800 --batch_size 2048 --i_c 0.1 --cls_weight 0.005 --n_clusters 3 --structure_weight 1e-1 --nepoch 250 > flo2.log 2>&1 &
# 5-shot GFSL: best_seen=0.957, best_unseen=0.854, best_h=0.903, run_time=1548.3417
# CUDA_VISIBLE_DEVICES=3 python3 -u main.py --dataset FLO --num_shots 10 --a 1e-2 --b 1e-3 --c 1e-3 --nz 400 --center_weight 0.001 --syn_num 800 --batch_size 2048 --i_c 0.1 --cls_weight 0.005 --n_clusters 3 --structure_weight 1e-1 --nepoch 250 > flo3.log 2>&1 &
# 10-shot GFSL: best_seen=0.964, best_unseen=0.899, best_h=0.931, run_time=1595.5786
#
# FSL setting
# CUDA_VISIBLE_DEVICES=0 python3 -u main.py --generalized False  --dataset FLO --num_shots 1 --a 1e-4 --b 1e-3 --c 1e-3 --nz 200 --center_weight 0.01 --syn_num 1600 --batch_size 2048 --i_c 0.1 --cls_weight 0.005 --n_clusters 1  --structure_weight 1e-1 --nepoch 500  > flo0.log 2>&1 &
# 1-shot FSL: best_t=0.7844, run_time=4918.3342
# CUDA_VISIBLE_DEVICES=0 python3 -u main.py --generalized False  --dataset FLO --num_shots 3 --a 1e-4 --b 1e-3 --c 1e-3 --nz 200 --center_weight 0.01 --syn_num 1600 --batch_size 2048 --i_c 0.1 --cls_weight 0.005 --n_clusters 3 --structure_weight 1e-1 --nepoch 500 > flo1.log 2>&1 &
# 3-shot FSL:  best_t=0.9035, run_time=2853.1971
# CUDA_VISIBLE_DEVICES=1 python3 -u main.py --generalized False  --dataset FLO --num_shots 5 --a 1e-4 --b 1e-3 --c 1e-3 --nz 200 --center_weight 0.01 --syn_num 1600 --batch_size 2048 --i_c 0.1 --cls_weight 0.005 --n_clusters 3 --structure_weight 1e-1 --nepoch 500 > flo2.log 2>&1 &
# 5-shot FSL: best_t=0.9248, run_time=3054.4516
# CUDA_VISIBLE_DEVICES=1 python3 -u main.py --generalized False  --dataset FLO --num_shots 10 --a 1e-4 --b 1e-3 --c 1e-3 --nz 200 --center_weight 0.01 --syn_num 1600 --batch_size 2048 --i_c 0.1 --cls_weight 0.005 --n_clusters 3 --structure_weight 1e-1 --nepoch 500 > flo3.log 2>&1 &
...
class myArgs():
    def __init__(self, args):
        ...
        self.center_weight = args.center_weight; self.n_clusters = args.n_clusters; self.structure_weight = args.structure_weight
        ...
        self.metric = 'cosine';self.proto_param1 = 1e-1; self.proto_param2 = 3e-2; self.ratio = 0.4; self.manualSeed = 806; self.preprocessing = True
